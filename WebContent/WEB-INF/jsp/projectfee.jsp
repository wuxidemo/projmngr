...
function submitcreatefee(){
    ...
    xmlhttp.open("POST","submitcreatefee?projectsn=" + projectsn + "&feecontent=" + feecontent + "&receiptamount=" + receiptamount + "&payamount=" + payamount);
...
function alertinfo(){
	if(xmlhttp.readyState == 4){
		if(xmlhttp.status == 200){
			...
			json = eval(json.createfee);
			if(json.length > 0){
				var msg = json[0].msg;
				if(msg != "" && msg != undefined){
					alert(msg);					
					document.getElementById("projectsn").value = "";
					document.getElementById("feecontent").value = "";
...
<h2 class="form-signin-heading">请输入事业部费用相关信息</h2>
<div class="container div">
    ...
    <div class="input-group input-group-lg">
         ...
         <input type="text" style="width:400px;text-align:left;" class="form-control" value="" placeholder="请输入摘要" name="feecontent" id="feecontent" />
    </div>
    <div class="input-group input-group-lg">
         <span style="width:250px;text-align:right;" class="input-group-addon text-right">收票金额:</span>
         <input type="text" style="width:400px;text-align:left;" class="form-control" value="" placeholder="请输入收票金额" name="receiptamount" id="receiptamount" onkeyup="value=value.replace(/[^\d.]/g,'')" />
    </div> 
    <div class="input-group input-group-lg">
    ...
    <br>
    <button style="width:620px;text-align:center;" class="btn btn-lg btn-primary btn-block" type="submit" onclick="submitcreatefee()">事业部费用录入</button><br>
