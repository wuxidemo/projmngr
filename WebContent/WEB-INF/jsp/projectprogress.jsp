...
var xmlhttp;
function submitcreateprogress(){
	var projectsn = $("#projectsn").val();
	if(projectsn == ""){
		alert("请输入项目编号");
		return;
	}
	var projectplancost = $("#projectplancost").val();

	var projectprogress = $("#projectprogress").val();

	var projectoverview = $("#projectoverview").val();
	var projectplanreceipt = $("#projectplanreceipt").val();
    ...
    xmlhttp.open("POST","submitcreateprogress?projectsn=" + projectsn + "&projectplancost=" + projectplancost + "&projectprogress=" + projectprogress 
			 + "&projectoverview=" + projectoverview + "&projectplanreceipt=" + projectplanreceipt);
...
<h2 class="form-signin-heading">请输入项目进度相关信息</h2>
<div class="container div">
    ...
    <div class="input-group input-group-lg">
         <span style="width:250px;text-align:right;" class="input-group-addon text-right">预算成本:</span>
         <input type="text" style="width:400px;text-align:left;" class="form-control" value="" placeholder="请输入预算成本" name="projectplancost" id="projectplancost" onkeyup="value=value.replace(/[^\d.]/g,'')"/>
    </div>
    <div class="input-group input-group-lg">
         <span style="width:250px;text-align:right;" class="input-group-addon text-right">项目进度百分比(%):</span>
         <input type="text" style="width:400px;text-align:left;" class="form-control" value="" placeholder="请输入项目进度百分比" name="projectprogress" id="projectprogress" onkeyup="value=value.replace(/[^\d.]/g,'')"/>
    </div> 
    <div class="input-group input-group-lg">
         <span style="width:250px;text-align:right;" class="input-group-addon text-right">项目情况说明:</span>
         <input type="text" style="width:400px;text-align:left;" class="form-control" value="" placeholder="请输入项目情况说明" name="projectoverview" id="projectoverview" />
    </div>    

    <div class="input-group input-group-lg">
         <span style="width:250px;text-align:right;" class="input-group-addon">回款时间点:</span>
         <input type="text" style="width:400px;text-align:left;" class="form-control" value="" placeholder="请输入回款时间点" name="projectplanreceipt" id="projectplanreceipt" />
         <!-- input type="text" class="form-control" style="width:350px;height:50px;" id="projectplanreceipt"  value="" readonly placeholder="请选择回款时间点" /-->
		 <!-- span class="input-group-addon" style="width:50px;"><span class="glyphicon glyphicon-th"></span></span-->
    </div>
    
    <br>
    <button style="width:620px;text-align:center;" class="btn btn-lg btn-primary btn-block" type="submit" onclick="submitcreateprogress()">项目进度录入</button><br>
